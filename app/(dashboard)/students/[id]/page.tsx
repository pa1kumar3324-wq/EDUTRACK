...
export default async function StudentProfilePage({
  ...
  const englishRecommendation = recommendNextTopic(
    "english",
    roadmap,
    typedHistory
  );

  const mathRecommendation = recommendNextTopic(
    "math",
    roadmap,
    typedHistory
  );
            ...
            {englishRecommendation ? (
              <>
                <p className="font-medium">
                  {englishRecommendation.topic}
                </p>

                <p className="mt-1 text-sm text-muted-foreground">
                  {englishRecommendation.reason}
                </p>

                {englishRecommendation.isRevision && (
        ...
        <Card>
          ...
          <CardContent>
            {mathRecommendation ? (
              <>
                <p className="font-medium">
                  {mathRecommendation.topic}
                </p>

                <p className="mt-1 text-sm text-muted-foreground">
                  {mathRecommendation.reason}
                </p>

                {mathRecommendation.isRevision && (
                  <Badge variant="warning" className="mt-2">
                    Needs revision
                  </Badge>
                )}
